...
import jp.techacademy.tomotaka.aruga.taskapp.databinding.ActivityInputBinding
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*
//このクラスは、タスクの追加や編集を行うための画面を制御する役割を持っています。
// ユーザーが入力したタスクの情報をRealmデータベースに保存し、
// そのタスクの日時にアラームを設定することで、
//　ユーザーにタスクの通知を行うことができます。
